...
<body id="page-top">
  ...
  @include('layout.admin_sidebar')
    ...
    <form method="post" action="{{route('stwahanatocabang.update', $stwahanatocabang->id_stwahanatocabang)}}" class="container-fluid">
        @csrf
        @method('put')
        <input type="text" name="id_stwahanatocabang" value="{{$stwahanatocabang->id_stwahanatocabang}}" hidden>
        ...
        <div class="form-group row">
            <div class="col-sm-6 mb-3 mb-sm-0">
              ...
              <input type="date" class="form-control @error('tgl_st') is-invalid @enderror" name="tgl_st" value="{{ $stwahanatocabang->tgl_st }}" required autocomplete="tgl_st" autofocus>
            </div>
        </div>
        <div class="form-group row">
          <div class="col-sm-6 mb-3 mb-sm-0">
            <label for="">Nama Yang Menyerahkan</label>
            <input type="text" class="form-control @error('nama_penyerah') is-invalid @enderror" name="nama_penyerah" value="{{ $stwahanatocabang->nama_penyerah }}" required autocomplete="nama_penyerah" autofocus>
          </div>
          <div class="col-sm-6 mb-3 mb-sm-0">
            <label for="">Nama Yang Menerima</label>
            <input type="text" class="form-control @error('nama_penerima') is-invalid @enderror" name="nama_penerima" value="{{ $stwahanatocabang->nama_penerima }}" required autocomplete="nama_penerima" autofocus>
          </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-12">
              <label for="">Keterangan</label>
              <input type="text" class="form-control" name="keterangan" value="{{ $stwahanatocabang->keterangan }}" readonly>
            </div>
        </div>
