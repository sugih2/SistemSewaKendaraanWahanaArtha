    ...
    <div class="col-sm-6">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          ...
          <input type="text" class="form-control @error('harga_sewa') is-invalid @enderror" name="harga_sewa" id="harga_sewa" value="{{ old('harga_sewa') }}" required autocomplete="harga_sewa" autofocus>
        </div>
      </div>
